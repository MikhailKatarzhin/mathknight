...
public class Personality {
    ...
    @Column(name = "patronimyc", nullable = false, updatable = false)
    ...
    public Personality(@NonNull String first_name, @NonNull String second_name, @NonNull String patronimyc
